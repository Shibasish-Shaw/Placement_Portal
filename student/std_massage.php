...
<body>
  ...
  <section class="home-section">
      <div class="text"><h1>MESSAGE FOR YOU </h1><hr>    
<?php
   try {
    ...
    if($stmt ->rowcount() > 0){
      ...
      $approve_t=$set['approved'];
        //echo $set['comments'];
        echo "<div class='Messages profile'>Message for your profile</div>
      <div class='Message'>".$set['comments']."</div>";
      }
    }
    } catch (Exception $e) {
    echo $e->getMessage();
   ...
   try {
     $rollNo=$_SESSION['user_id'];
    $stmt=$conn->query("SELECT * FROM setplacement.maintains_apply s WHERE s.rollNo=$rollNo ");
    if($stmt ->rowcount() > 0){
      while ($set=$stmt->fetch()) {
        print_r($set);
      $approve_t=$set['approved'];
        echo $set['comments'];
        echo "<div class='Messages profile'>Message for Appling Jobs</div>
      <div class='Message'>".$set['comments']."</div>";
      }
    }
    } catch (Exception $e) {
