...
<body>
  ...
  <section class="home-section">
      <div class="text">List of Placement Repesentaive<hr>
        
<?php
try{
$email_set=$_SESSION['email_id'] ;
$stm5 = $conn->query("SELECT * FROM setplacement.placement_rep ");
            if($stm5->rowcount() > 0){
                ...
                //  print_r($row);
                  ...
                  echo "<div class='from_get details'>department : ".$row['depertment']."</div>";
                  echo "</div>";
